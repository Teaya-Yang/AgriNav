...
class Quadcopter_T : public SimulationObject6DOF {
 public:
  ...
  virtual void GetTelemetryDataPackets(TelemetryPacket::data_packet_t &dataPacket1,
                                       ...
                                       TelemetryPacket::data_packet_t &dataPacket3,
                                       TelemetryPacket::data_packet_t &dataPacket4) {
    _logic.GetTelemetryDataPackets(dataPacket1, dataPacket2, dataPacket3, dataPacket4);
    return;
  }
