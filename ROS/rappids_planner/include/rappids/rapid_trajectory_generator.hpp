...
#include "single_axis_trajectory.hpp"
...
class RapidTrajectoryGenerator {
 public:
  ...
  /*! Test the trajectory for velocity feasibility.
   *
   * Test whether the velocity flown along the trajectory is feasible with
   * respect to a user defined boundary.
   *
   * @param vmin
   * @param vmax
   * @return An instance of StateFeasibilityResult.
