...
class RappidsPerceptionAware {
 public:
  ...
  void CallbackRCIn(const mavros_msgs::RCIn::ConstPtr &msg);
  ...
  void Run(const bool& shouldStart);
...
inline geometry_msgs::Quaternion toGeometricMsgQuaternion(const Rotation& rhs) {
 ...
 protected:
  ...
  ros::Publisher _ref_pub, _marker_pub, _pub_planner_diagnotics, _pub_flight_stage;
